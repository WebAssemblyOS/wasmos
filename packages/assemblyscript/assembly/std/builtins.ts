...
// @ts-ignore decorators is correct
@builtin export declare function sizeof<T>(): usize; // | u32 / u6;
// @ts-ignore decorators is correct
@builtin export declare function alignof<T>(): usize; // | u32 / u6;
// @ts-ignore decorators is correct
@builtin export declare function offsetof<T>(fieldName?: string): usize; // | u32 / u6;
// @ts-ignore decorators is correct
...
export namespace v128 {
  ...
  // @ts-ignore decorators is correct
  @builtin export declare function mul<T>(a: v128, b: v128): v128; // except i6;
  // @ts-ignore decorators is correct
  @builtin export declare function div<T>(a: v128, b: v128): v128; // f32, f64 onl;
  // @ts-ignore decorators is correct
  ...
  // @ts-ignore decorators is correct
  @builtin export declare function min<T>(a: v128, b: v128): v128; // f32, f64 onl;
  // @ts-ignore decorators is correct
  @builtin export declare function max<T>(a: v128, b: v128): v128; // f32, f64 onl;
  // @ts-ignore decorators is correct
  @builtin export declare function abs<T>(a: v128): v128; // f32, f64 onl;
  // @ts-ignore decorators is correct
  @builtin export declare function sqrt<T>(a: v128): v128; // f32, f64 onl;
  // @ts-ignore decorators is correct
